  ...
  useEffect(() => {
    ...
    const calculateHighlightedLinePositions = () => {
      ...
      if (positions.length > 0) {
        console.log("🎯 PersonalHeatmap: Calculated highlighted line positions", { count: positions.length, positions });
        ...
        <div className="overflow-x-auto thin-scrollbar" ref={heatmapContainerRef} style={{ position: 'relative', zIndex: 10 }}>
          ...
          {highlightedLinePositions && highlightedLinePositions.length > 1 && (() => {
            ...
            return (
              ...
              >
                <defs>
                  <linearGradient id="fomoLineGradient" x1="0%" y1="0%" x2="100%" y2="0%">
