  ...
  useEffect(() => {
    ...
    const calculatePositions = () => {
      if (!badge1Ref.current || !badge2Ref.current) {
        console.log("🔧 PersonalHeatmap: Badges not ready yet");
        return;
      }
      ...
      if (!containerRect) {
        console.log("🔧 PersonalHeatmap: Container not found");
        return;
      }
      ...
      console.log("🎯 PersonalHeatmap: Calculated badge positions", { x1, x2, y });
