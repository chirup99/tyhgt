...
export const MultipleImageUpload = forwardRef<MultipleImageUploadRef, MultipleImageUploadProps>(function MultipleImageUpload({ images: externalImages = [], onImagesChange }, ref) {
  ...
  return (
    <Card className="h-full border-2 border-gray-300 dark:border-gray-600 relative overflow-hidden transition-none">
      <CardContent className="p-0 h-full relative max-h-full">
        {images.length === 0 ? (
              ...
              <div className="absolute top-4 right-4 flex gap-2 z-50">
                ...
                {!isSaved ? (
                  ...
                  <Button
                    ...
                    data-testid={`button-remove-${currentIndex}`}
                  >
                    <X className="w-4 h-4" />
                  </Button>
                ) : (
                    ...
                    <DropdownMenuContent align="end" className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700">
                      ...
                      <DropdownMenuItem 
                        onClick={() => {
                          ...
                          link.download = currentImage.name || `image_${currentIndex + 1}`;
                          link.click();
                        }}
                        className="cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-700"
                      >
