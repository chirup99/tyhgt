          ...
          <div className="absolute inset-0 flex items-center justify-center">
            {cardsToShow.map((card, idx) => {
              ...
              return (
                ...
                >
                  <div className="relative rounded-2xl overflow-hidden shadow-lg bg-white dark:bg-black border border-gray-300 dark:border-gray-700" style={{ width: '300px', height: '220px' }}>
                    {(card as any).image ? (
                      <img
                      ...
                      <div className="w-full h-full flex flex-col items-center justify-center gap-2 p-4 bg-gray-100 dark:bg-gray-900">
